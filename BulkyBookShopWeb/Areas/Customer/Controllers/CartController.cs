...
namespace BulkyBookShopWeb.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPOST()
        {
            ...
            //if it is a customer = (PaymentStatusPending - StatusPending) --> (PaymentStatusApproved - StatusApproved) -->
            //(PaymentStatusApproved - StatusProcessing) --> (PaymentStatusApproved - StatusShipped)

            //if it is a Company = (ApprovedForDelayedPayment - StatusApproved) --> (ApprovedForDelayedPayment - StatusProcessing) -->
            //(ApprovedForDelayedPayment - StatusShipped) --> (PaymentStatusApproved - StatusShipped)
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            _emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "Thank you for your order! - Bulky Book",
                $"<div><h2><strong>Dear,{orderHeader.ApplicationUser.Name}</strong></h2><h3>New Order Has been Created..</h3><h4>Total Price: {orderHeader.OrderTotal.ToString("c")}<br/>Payment Status: {orderHeader.PaymentStatus}<br/>Order Status: {orderHeader.OrderStatus}</h4><br/><h5><strong>Thank you for using Bulky Book!</strong</h5><br/>Best regards,<br/>Bulky Book Team</h5></div>");
